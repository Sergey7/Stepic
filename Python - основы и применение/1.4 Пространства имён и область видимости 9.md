...
def add_func(name_space, value):
    perm[name_space].append(value)


def create(name_space, value):
    parents[value] = name_space


def get_name_space(name_space, value):
    if value in perm[name_space]:
        return name_space
    else:
        if name_space == 'global':
            return None
        return get_name_space(parents[name_space], value)
...
for i in range(a):
    comand, name_space, value = input().split()
    if 'add' == comand:
        add_func(name_space=name_space, value=value)
    if 'create' == comand:
        create(value=name_space, name_space=value)
    if 'get' == comand:
        print(get_name_space(name_space=name_space, value=value))
